...
import org.donggle.backend.application.service.tistory.response.TistoryTags;
...
public class TistoryTagsDeserializer extends JsonDeserializer<TistoryTags> {
    @Override
    public TistoryTags deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
