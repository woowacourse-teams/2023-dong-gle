...
public class NotionApiService {
    ...
    public NotionApiService(@Value("${notion_token_temp}") String notionToken) {
        this.notionToken = notionToken;
        this.webClient = WebClient.create(NOTION_URL);
    }

    public JsonNode retrieveParentBlock(String parentBlockId) {
    ...
    public JsonNode retrieveChildrenBlocks(String blockId) {
        return retrieveData(blockId, CHILD_BLOCK_URI);
    }
}
